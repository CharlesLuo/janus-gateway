...
if(window.location.protocol === 'http:')
	...
	//server = "http://104.198.85.126:8088/janus";
	//server = "http://10.10.10.25:8088/janus";
	server = "ws://52.193.178.174:8188";
else
	//server = "https://104.198.85.126:8089/janus";
						...
						janus.attach(
							{
								...
								onremotestream: function(stream) {
									...
									if($('#remotevideo').length === 0)
										$('#stream').append('<video class="rounded centered hide" id="remotevideo" width=1280 height=720 autoplay controls/>');
